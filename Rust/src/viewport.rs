pub mod viewport{
    ...
    use crate::objects::objects::{NO_HIT, Sphere, Object, materials::{empty, diffuse}};
    ...
    impl Viewport{
        pub fn new(width:u64, aspect_ratio:f32, samples: usize, depth:usize, gamma:f32)-> Self{
        ...
        pub fn new_from_res(width:u64, height:u64, samples:usize, depth:usize, gamma: f32) -> Self{
            Self::new(width, width as f32 / height as f32, samples, depth, gamma)
        }
    ...
    fn ray_color_d(r: Ray, scene: &Scene, depth:usize) -> Rgb<f32> {
        ...
        if hit != NO_HIT {
            let cm = hit.col_mod;
            // println!("depth: {}", depth);
            return (Vec3::from_rgb(ray_color_d((hit.mat)(hit, r), scene, depth-1)) * cm).to_rgb();
        }
    ...
    pub fn diffuse_test(){
        ...
        let spheres  = vec!{
            ...
            Sphere::new(Vec3 {x: 0.5, y: 0.0, z: -1.0,}, 0.5, Some(Vec3::new(1.0, 1.0, 1.0)), Some(&diffuse)),
