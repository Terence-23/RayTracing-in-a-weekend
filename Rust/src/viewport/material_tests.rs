use super::*;
    ...
    use crate::objects::materials::{EMPTY_M, SCATTER_M, METALLIC_M, FUZZY3_M, GLASS_M, GLASSR_M};
    ...
    pub fn metal_test(){
        let samples = 100;
        let spheres  = vec!{
            Sphere::new(Vec3 {x: -1.0, y: 0.0, z: -1.0,}, 0.5, Some(Vec3::new(0.8, 0.8, 0.8)), Some(FUZZY3_M)),
